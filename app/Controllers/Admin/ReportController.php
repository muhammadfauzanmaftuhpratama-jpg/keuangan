...
class ReportController extends BaseController {
    ...
    public function index(){
        ...
        return view('admin/report/index',array_merge($data,['title'=>'Laporan Keuangan','monthName'=>date('F',mktime(0,0,0,(int)$m,1)),'prevMonthName'=>date('F',mktime(0,0,0,(int)$pm,1)),'prevIncome'=>$pi,'prevExpense'=>$pe,'incomeChange'=>$pi>0?round((($data['totalIncome']-$pi)/$pi)*100,1):0,'expenseChange'=>$pe>0?round((($data['totalExpense']-$pe)/$pe)*100,1):0]));
    }
    ...
    public function yearly(){
        ...
        return view('admin/report/yearly',['title'=>'Laporan Tahunan '.$y,'year'=>$y,'monthlyData'=>$md,'totalYearIncome'=>$ti,'totalYearExpense'=>$te,'totalYearBalance'=>$ti-$te,'chartLabels'=>json_encode(array_column($md,'month_name')),'chartIncome'=>json_encode(array_column($md,'income')),'chartExpense'=>json_encode(array_column($md,'expense'))]);
    }
