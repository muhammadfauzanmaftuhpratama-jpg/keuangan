...
<div id="main-content"><?= view('admin/layouts/navbar') ?>
    <div class="content-area">
        <div class="d-flex align-items-center gap-2 mb-4">
            <a href="/user/<?= $type === 'income' ? 'income' : 'expense' ?>" class="btn btn-sm btn-light"><i
        ...
        <?php if (session()->getFlashdata('errors')): ?>
            <div class="alert alert-danger">
                <ul class="mb-0"><?php foreach (session()->getFlashdata('errors') as $e): ?>
            ...
            <div class="card-body p-4">
                <form action="/user/<?= $type === 'income' ? 'income' : 'expense' ?>/store" method="POST">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group"><span class="input-group-text">Rp</span><input type="number"
                                    name="amount" class="form-control" placeholder="0" min="1"
                    ...
                    <div class="d-flex gap-2">
                        <button type="submit" class="btn btn-<?= $type === 'income' ? 'success' : 'danger' ?>"><i
