...
<a href="/admin/category/create" class="btn btn-primary btn-sm"><i class="bi bi-plus-lg me-1"></i>Tambah Kategori</a>
</div>
...
<a href="/admin/category/edit/<?= $cat['id'] ?>" class="btn btn-warning btn-sm"><i class="bi bi-pencil"></i></a>
<?php if(!$cat['is_default']): ?><button class="btn btn-danger btn-sm" onclick="confirmDelete('/admin/category/delete/<?= $cat['id'] ?>','<?= esc($cat['name']) ?>')"><i class="bi bi-trash"></i></button><?php else: ?><button class="btn btn-secondary btn-sm" disabled><i class="bi bi-lock"></i></button><?php endif; ?>
</div></div>
