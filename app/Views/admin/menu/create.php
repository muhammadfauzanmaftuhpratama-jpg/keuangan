...
<div class="d-flex align-items-center gap-2 mb-4"><a href="/admin/menu" class="btn btn-sm btn-light"><i class="bi bi-arrow-left"></i></a><h5 class="fw-bold mb-0">Tambah Menu</h5></div>
...
<form action="/admin/menu/store" method="POST"><?= csrf_field() ?>
<div class="row g-3">
<div class="col-md-6"><label class="form-label fw-semibold small">Nama Menu <span class="text-danger">*</span></label><input type="text" name="name" class="form-control" value="<?= old('name') ?>" required></div>
<div class="col-md-6"><label class="form-label fw-semibold small">Slug <span class="text-danger">*</span></label><input type="text" name="slug" class="form-control" value="<?= old('slug') ?>" placeholder="admin-menu" required></div>
<div class="col-md-6"><label class="form-label fw-semibold small">Icon <small class="text-muted">(Bootstrap Icons)</small></label><div class="input-group"><span class="input-group-text"><i id="iconPrev" class="bi bi-circle"></i></span><input type="text" name="icon" id="iconIn" class="form-control" value="<?= old('icon','bi bi-circle') ?>" placeholder="bi bi-circle"></div></div>
<div class="col-md-6"><label class="form-label fw-semibold small">URL <span class="text-danger">*</span></label><input type="text" name="url" class="form-control" value="<?= old('url') ?>" placeholder="/admin/xxx" required></div>
