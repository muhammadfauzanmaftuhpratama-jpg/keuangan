...
<form method="GET" action="/user/dashboard" class="row g-2 align-items-end">
...
<div class="col-md-3 col-sm-6"><div class="card stat-card p-3"><div class="d-flex align-items-center gap-3"><div class="rounded-3 p-2" style="background:#d1fae5"><i class="bi bi-arrow-down-circle fs-4" style="color:#10b981"></i></div><div><div class="text-muted small">Pemasukan</div><div class="fw-bold text-success"><?= rupiah($totalIncome) ?></div></div></div></div></div>
<div class="col-md-3 col-sm-6"><div class="card stat-card p-3"><div class="d-flex align-items-center gap-3"><div class="rounded-3 p-2" style="background:#fee2e2"><i class="bi bi-arrow-up-circle fs-4" style="color:#ef4444"></i></div><div><div class="text-muted small">Pengeluaran</div><div class="fw-bold text-danger"><?= rupiah($totalExpense) ?></div></div></div></div></div>
<div class="col-md-3 col-sm-6"><div class="card stat-card p-3"><div class="d-flex align-items-center gap-3"><div class="rounded-3 p-2" style="background:#e0e7ff"><i class="bi bi-wallet2 fs-4" style="color:#667eea"></i></div><div><div class="text-muted small">Saldo</div><div class="fw-bold <?= $balance<0?'text-danger':'text-primary' ?>"><?= rupiah($balance) ?></div></div></div></div></div>
<div class="col-md-3 col-sm-6"><div class="card stat-card p-3"><div class="d-flex align-items-center gap-3"><div class="rounded-3 p-2" style="background:#fef3c7"><i class="bi bi-piggy-bank fs-4" style="color:#f59e0b"></i></div><div><div class="text-muted small">Tabungan</div><div class="fw-bold text-warning"><?= rupiah($totalSaving) ?></div></div></div></div></div>
</div>

<?php if($totalDebt>0): ?>
<div class="alert alert-warning d-flex align-items-center gap-2 mb-4">
<i class="bi bi-exclamation-triangle"></i>
<div>Total hutang aktif: <strong><?= rupiah($totalDebt) ?></strong> — <a href="/user/debt" class="alert-link">Lihat detail</a></div>
</div>
<?php endif; ?>
...
<a href="/user/income" class="small text-primary">Semua</a>
</div>
