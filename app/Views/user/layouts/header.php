...
<title><?= $title ?? 'Keuangan Pribadi' ?></title>
...
#sidebar .nav-section{color:rgba(255,255,255,.3);font-size:.65rem;font-weight:600;text-transform:uppercase;letter-spacing:1px;padding:8px 24px 4px}
