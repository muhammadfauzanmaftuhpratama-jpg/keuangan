...
<div class="d-flex align-items-center gap-2 mb-4"><a href="/user/category" class="btn btn-sm btn-light"><i class="bi bi-arrow-left"></i></a><h5 class="fw-bold mb-0">Edit Kategori</h5></div>
...
<form action="/user/category/update/<?= $category['id'] ?>" method="POST"><?= csrf_field() ?>
<div class="row g-3">
...
<hr><div class="d-flex gap-2"><button type="submit" class="btn btn-warning btn-sm"><i class="bi bi-save me-1"></i>Update</button><a href="/user/category" class="btn btn-light btn-sm">Batal</a></div>
</form></div></div>
</div></div>
