...
<a href="/user/report" class="btn btn-outline-secondary btn-sm"><i class="bi bi-arrow-left me-1"></i>Laporan Bulanan</a>
</div>

<div class="card stat-card p-3 mb-4">
<form method="GET" action="/user/report/yearly" class="row g-2 align-items-end">
