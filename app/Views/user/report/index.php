...
<a href="/user/report/export-pdf?month=<?= $month ?>&year=<?= $year ?>" class="btn btn-danger btn-sm" target="_blank"><i class="bi bi-file-earmark-pdf me-1"></i>PDF</a>
<a href="/user/report/export-excel?month=<?= $month ?>&year=<?= $year ?>" class="btn btn-success btn-sm"><i class="bi bi-file-earmark-excel me-1"></i>Excel</a>
<a href="/user/report/export-csv?month=<?= $month ?>&year=<?= $year ?>" class="btn btn-secondary btn-sm"><i class="bi bi-file-earmark-text me-1"></i>CSV</a>
<a href="/user/report/yearly?year=<?= $year ?>" class="btn btn-info btn-sm text-white"><i class="bi bi-calendar3 me-1"></i>Tahunan</a>
</div>
</div>

<div class="card stat-card p-3 mb-4">
<form method="GET" action="/user/report" class="row g-2 align-items-end">
